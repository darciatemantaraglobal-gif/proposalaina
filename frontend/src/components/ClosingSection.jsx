...
import { ArrowRight, Sparkles, Mail, Calendar, Rocket, Users, Layers, Bot, User, Send, CheckCircle2 } from 'lucide-react';

// --- KOMPONEN DEMO CHAT (Disertakan agar mandiri) ---
const ChatDemo = () => {
  return (
    <div className="relative w-[300px] sm:w-[350px] mx-auto bg-[#0e0e12] border border-white/10 rounded-[40px] overflow-hidden shadow-2xl shadow-purple-900/50">
      ...
      <div className="flex-1 bg-[#050509] p-4 flex flex-col gap-4 h-[400px] overflow-hidden relative">
        ...
        <div className="flex items-start gap-2">
           <div className="bg-[#1a1a24] p-3 rounded-2xl rounded-tl-none border border-white/5 text-slate-300 text-[11px] leading-relaxed max-w-[90%]">
              <p>Progres AINA sudah 90%. Siap diluncurkan untuk Masisir! 🚀</p>
           </div>
        </div>
        ...
        <div className="flex items-start gap-2 justify-end">
           <div className="bg-gradient-to-r from-purple-600 to-purple-500 p-3 rounded-2xl rounded-tr-none text-white text-[11px] leading-relaxed max-w-[90%] shadow-lg">
              <p>Wah, mantap! Apa yang masih dibutuhkan sekarang?</p>
           </div>
        </div>
        ...
        <div className="flex items-start gap-2">
           <div className="bg-[#1a1a24] p-3 rounded-2xl rounded-tl-none border border-white/5 text-slate-300 text-[11px] leading-relaxed max-w-[90%] space-y-2">
              <p>Dukungan partner strategis untuk server & operasional awal.</p>
              <div className="flex items-center gap-2 mt-1">
                 <span className="text-[9px] px-2 py-1 bg-cyan-500/10 text-cyan-400 rounded border border-cyan-500/20">Proposal Ready ✅</span>
              </div>
           </div>
        </div>
      ...
      <div className="p-3 bg-[#13131a] border-t border-white/5">
        <div className="flex items-center gap-2 bg-[#0a0a0f] border border-white/10 rounded-full px-3 py-2">
          <input disabled type="text" placeholder="Reply..." className="bg-transparent text-[10px] w-full outline-none text-slate-500" />
  ...
  return (
    <section className="relative bg-[#050509] pt-24 pb-0 overflow-hidden font-sans text-slate-300">
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 relative z-20">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-white to-cyan-400">
              Masisir Bersama AINA.
            </span>
          </h2>

          <p className="text-slate-400 text-base md:text-lg mb-10 leading-relaxed">
            Proyek sudah <span className="text-white font-semibold">90% selesai</span>. Kami siap mendemokan sistem ini langsung di hadapan Anda. Jadilah bagian dari sejarah.
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="group relative inline-flex items-center gap-2 px-8 py-4 bg-white text-[#050509] rounded-full font-bold text-sm shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_40px_rgba(168,85,247,0.4)] hover:scale-105 transition-all duration-300">
              <Mail className="w-4 h-4" />
              <span>Hubungi Kami</span>
            </button>
            
            <button className="inline-flex items-center gap-2 px-8 py-4 rounded-full border border-white/10 bg-white/5 text-white font-semibold text-sm backdrop-blur-sm hover:bg-white/10 hover:border-purple-500/50 transition-all">
        ...
        {/* 2. VISUAL AREA (Phone Center + Floating Widgets) */}
        <div className="relative mt-20 min-h-[500px] flex justify-center">
          
          {/* Main Glow Behind Phone */}
          ...
          {/* --- CENTRAL PHONE (Chat Demo) --- */}
          <div className="relative z-20 transform hover:scale-[1.02] transition-transform duration-500">
             <ChatDemo />
          </div>

          {/* --- FLOATING WIDGETS (Absolute Positioning) --- */}
          
          {/* Widget 1: Development Status (Left) */}
          <div className="absolute top-20 left-0 md:left-20 lg:left-40 z-30 animate-bounce duration-[4000ms]">
             <div className="bg-[#13131a]/80 backdrop-blur-xl border border-white/10 p-4 pr-8 rounded-2xl shadow-xl flex items-center gap-4 hover:border-purple-500/40 transition-colors">
                ...
                <div>
                   ...
                   <p className="text-slate-400 text-xs">Development Selesai</p>
                </div>
             </div>
          </div>

          {/* Widget 2: Target Market (Right Top) */}
          <div className="absolute top-10 right-0 md:right-20 lg:right-40 z-10 animate-bounce duration-[5000ms] delay-700">
             <div className="bg-[#13131a]/80 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-xl flex items-center gap-3 hover:border-cyan-500/40 transition-colors">
                <div className="flex -space-x-2">
                   ...
                   <div className="w-8 h-8 rounded-full bg-cyan-600 border-2 border-[#13131a] flex items-center justify-center text-[8px] text-white font-bold">+10K</div>
                </div>
                <div>
                   <p className="text-white font-bold text-sm">Target User</p>
                   <p className="text-cyan-400 text-[10px]">Mahasiswa Aktif</p>
                </div>
             </div>
          </div>

          {/* Widget 3: Features Live (Right Bottom) */}
          <div className="absolute bottom-40 right-4 md:right-10 lg:right-32 z-30 animate-bounce duration-[6000ms] delay-300">
             <div className="bg-[#13131a]/80 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-xl hover:border-emerald-500/40 transition-colors">
                <div className="flex items-center gap-2 mb-2">
                   ...
                   <span className="text-slate-300 text-xs font-medium">Core Features</span>
                </div>
                <div className="flex gap-1 h-8 items-end">
                   ...
                   <span className="ml-2 text-xl font-bold text-white">8 <span className="text-xs font-normal text-slate-500">Live</span></span>
                </div>
             </div>
          </div>

          {/* Widget 4: Small Badge (Left Bottom) */}
          <div className="absolute bottom-20 left-4 md:left-10 lg:left-32 z-10 transform rotate-[-6deg]">
             <div className="px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full text-white text-xs font-bold shadow-lg flex items-center gap-2">
