  ...
  <section className="bg-[#050509] py-8 md:py-20 px-4 md:px-6">
    <div className="max-w-5xl mx-auto">
      <div className="mb-5 md:mb-14">
        ...
        <p className="mt-2 text-xs md:text-sm text-slate-400 max-w-xl">Bukan konsep. Semua sudah dibangun, diuji, dan aktif berjalan.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        {features.map((f, i) => {
          ...
          return (
            <div key={i} className="group bg-[#0c0c14] border border-purple-500/20 rounded-2xl p-3 md:p-4 hover:border-purple-500/25 transition-all duration-300 hover:-translate-y-0.5">
