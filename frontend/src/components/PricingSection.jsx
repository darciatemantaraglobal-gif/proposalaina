...
const tiers = [
  ...
  },
  {
    ...
    monthly: 300000,
    annual: 2550000,
    desc: 'Eksposur terkuat untuk UMKM — dengan rekomendasi langsung dari AI ke Masisir.',
    benefits: [
      'Banner prioritas di beranda + halaman AI Chat',
      'Profil bisnis featured di direktori mitra AINA',
      '2 announcement per bulan ke seluruh pengguna',
      '1 pinned post di forum komunitas per bulan',
      'AINA rekomendasikan bisnis kamu saat pertanyaan pengguna relevan',
  ...
  },
  {
    ...
    benefits: [
      ...
      'Rekomendasi AI terintegrasi penuh di semua topik relevan',
