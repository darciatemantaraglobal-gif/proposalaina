...
import { FileWarning, BookX, MapPin, ZapOff, AlertTriangle, ArrowRight } from 'lucide-react';

const ProblemSection = () => {
  const problems = [
    {
      icon: FileWarning,
      title: 'Administrasi & Birokrasi',
      highlight: 'Level: Critical',
      desc: 'Proses kompleks (Visa, Iqamah, Tasjil) dengan informasi yang tidak terpusat dan sering berubah-ubah.',
      items: [
        '3-5x kunjungan bolak-balik instansi',
        'Risiko denda keterlambatan tinggi',
        'Informasi simpang siur (katanya/katanya)'
      ],
      color: 'purple'
    },
    {
      ...
      highlight: 'Level: High',
      desc: 'Kesenjangan bahasa dan metode belajar membuat materi turats sulit dicerna mahasiswa baru.',
      items: [
        'Sulit memahami kitab klasik (Turats)',
        'Minim referensi terjemahan valid',
        'Kurang persiapan ujian (Imtihan)'
      ],
      color: 'cyan'
    },
    {
      ...
      desc: 'Culture shock dan kebingungan navigasi di negara baru tanpa panduan yang terpercaya.',
      items: [
        'Tidak tahu lokasi strategis/penting',
        'Bingung akses layanan kesehatan',
        'Rawan scam/penipuan lokal'
      ],
      color: 'purple'
    },
    {
      icon: ZapOff,
      title: 'Krisis Produktivitas',
      highlight: 'Level: Medium',
      desc: 'Tanpa sistem monitoring, mahasiswa mudah kehilangan motivasi dan arah tujuan awal.',
      items: [
        ...
        <div className="mb-16 md:mb-20 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white leading-tight">
              Kenali <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400">Musuh Utama</span> <br />
              Produktivitas Masisir.
            </h2>
          </div>
          ...
          <div className="text-slate-400 text-sm md:text-right max-w-xs leading-relaxed border-l-2 md:border-l-0 md:border-r-2 border-purple-500/30 pl-4 md:pl-0 md:pr-4">
            <p>
              Masalah ini nyata, berulang setiap tahun, dan menghambat ribuan mahasiswa untuk berkembang.
            </p>
          </div>
        </div>
                  ...
                  <ul className="space-y-3 mt-auto">
                    {item.items.map((subItem, idx) => (
                      <li key={idx} className="flex items-start gap-2.5">
                        <div className={`mt-1.5 w-1 h-1 rounded-full ${isPurple ? 'bg-purple-500' : 'bg-cyan-400'}`} />
          ...
          <div className="inline-block relative group">
             ...
             <div className="relative bg-[#0e0e12] border border-white/10 rounded-full px-8 py-4 flex items-center gap-3">
                <span className="text-sm text-slate-300">
                  Tanpa solusi, masalah ini terus berulang. <span className="text-white font-semibold">AINA hadir untuk memutus siklusnya.</span>
                </span>
